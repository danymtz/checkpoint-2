...
export class SidenavComponent implements OnInit {
  ...
  @Output()
  propagar = new EventEmitter<any>();                      // Output para transmitir los juegos

  constructor(private requestService: RequestService) { }

  ngOnInit(): void {
    this.genres$ = this.requestService.getGenres();       // Obtenemos los géneros
  }
  ...
  showGenre(genre: number){                                     // Recibe Id del juego que selecciona el usuario
    ...
    this.propagar.emit(this.games$);                            // Propagación de los juegos
  }
}
